    ...
    with torch.no_grad():
        for batch in loader:
            ...
            for _ in range(num_samples): # num_samples = 20 cz best_k = 20, then take the min in helper over the 20 runs
                ...
                # save pred_traj_fake and pred_traj_gt .. else plot live motion
            ...
            #print("########################## gt shape=",pred_traj_gt.shape)
            #print("########################## pred shape=",pred_traj_fake.shape)
            #break

        #print("########################## batches len=",len(pred_traj))
        if (save):
